...
\chapter{GUI的构建} % 1674+226 + 257 + 139 = 2296
...
\chapter{middleware的构建} % 641 + 94 + 19 = 754
...
\chapter{LLM的微调} % 1820 + 119 + 197 = 2136
...
\buptfigure[width=0.7\textwidth]{pictures/model_performance}{LLM 指令生成性能}{model_performance_TMP}
...
\chapter{Stable Diffusion及扩展的使用} % 439 + 106 + 37 = 582
...
\buptfigure[width=0.7\textwidth]{pictures/gui_multimodal}{交互式图像编辑}{gui_multimodal_TMP}
